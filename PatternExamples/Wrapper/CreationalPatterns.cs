...
public static class CreationalPatterns
{
    ...
    public static void SingletoneDemo()
    {
    ...
    public static void ProcessProfileCreation(IProfileFactory factory, string factoryType)
    {
    ...
    public static void ObjectPoolDemo()
    {
